...
let currencyName="NA"
//let currency=countries[0].currencies;
// let currencyName=countries[0].currencies[0].name
if("currencies" in country)
 currencyName=country.currencies[0].name

console.log(`countryname=> ${countryName} , popolation=> ${population}, capital=> ${capital}, currency=> ${currencyName}`);
let cn={}
 cn={countryName,population,currencyName,capital}
 myCountries.push(cn)
}
...
//   }
// }
// let india =myCountries.find(data=>data.countryName=="India")
// console.log(india);
 //let chinacurr=myCountries.find(data=>data.countryName=="China")
 //0console.log(chinacurr.currencyName);
  let chinacurr=myCountries.find(data=>data.countryName=="China").currencyName
   console.log(chinacurr);

//Above 2 crore population//

let abovepopulation=[]
abovepopulation=myCountries.filter(data=>data.population>20000000)
console.log(abovepopulation);

myCountries.filter(data=>data.population>20000000).map(cntry=>cntry.countryName)
