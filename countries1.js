var countries=[
  ...
  for(let data of countries)
  {
     ...
     cn={ countryname,countrycapital,cpopulation,currency}
     my_countries.push(cn)
     //console.log(` countryname=${countryname} countrycaoital=${countrycapital} population=${cpopulation} currency=${currency}`);
  }
